...
public class RegisterUserRequest {
    ...
    @Schema(nullable = true, description = "Код для регистрации админов. Если не совпадает ConflictException. Для регистрации пользователя должен отсутствовать(null)")
